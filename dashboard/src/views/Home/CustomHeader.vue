    ...
    <div class="header-group">
      ...
      <div class="flex flex-col mt-28">
        ...
        <p class="text-lg text-white">
          Receba ideias e reclamações e feedbacks com um <br class="hidden lg:inline-block">
...
.header{
  @apply bg-brand-main w-full flex justify-center pt-10;
  height: 700px;
}
